...
const GAME_DATA = {
    ...
    paperZones: [
        ...
        { id: 'zone3', name: '3区',   mult: 2.5,  requireCombo: 18,  baseSuccess: 0.70, icon: '📘',
          desc: 'SCI 3区 · 中级期刊，市级/青年科学基金重点资助', rewardPrestigeMult: 1.5 },
        { id: 'zone2', name: '2区',   mult: 6,    requireCombo: 40,  baseSuccess: 0.45, icon: '📙',
          desc: 'SCI 2区 · 权威期刊，国家自然科学面上项目资助', rewardPrestigeMult: 4 },
        { id: 'zone1', name: '1区',   mult: 15,   requireCombo: 65,  baseSuccess: 0.22, icon: '📕',
          desc: 'SCI 1区 · 顶尖期刊，国家重点研发计划千万级战略资助', rewardPrestigeMult: 10 },
        { id: 'supreme', name: '顶刊', mult: 40,  requireCombo: 90,  baseSuccess: 0.08, icon: '👑',
